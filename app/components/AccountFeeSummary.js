      ...
      <div className="mb-6">
        <div className="bg-white rounded-lg shadow-sm border p-6">
          <div className="text-center">
            ...
            <p className="text-gray-500">Thêm phí tài khoản để xem thống kê tổng quan.</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="mb-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-500">Tổng phí</p>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-500">Số lượng phí</p>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-500">Phí trung bình</p>
              <p className="text-2xl font-semibold text-gray-900">{formatCurrency(averageAmount)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-500">Phí cao nhất</p>
      ...
      {sortedStats.length > 0 && (
        <div className="bg-white rounded-lg shadow-sm border p-6">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Phân tích theo loại phí</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {sortedStats.map((stat, index) => {
              const percentage = totalAmount > 0 ? ((stat._sum?.amount || 0) / totalAmount) * 100 : 0;
              return (
                <div key={stat.feeType} className="p-4 border rounded-lg">
                  ...
                  <div className="space-y-1">
                    <div className="flex justify-between">
                      ...
                      <span className="text-sm font-medium">{formatCurrency(stat._sum?.amount || 0)}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-sm text-gray-500">Số lượng:</span>
                      <span className="text-sm font-medium">{getCountValue(stat._count)}</span>
                    </div>
                    <div className="flex justify-between">
