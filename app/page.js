...
export default function HomePage() {
  ...
  return (
    <>
      ...
      <div className="bg-gray-50" style={{ marginTop: '-80px', paddingTop: '0px' }}>
        {/* Mobile Menu Overlay */}
            ...
            <div className="flex justify-between items-center">
              ...
              <nav className="hidden md:block">
                <ul className="flex space-x-8 font-medium">
                  <li><a href="#" className="hover:text-blue-200 transition">Trang chủ</a></li>
                  <li><a href="#features" className="hover:text-blue-200 transition">Tính năng</a></li>
                  <li><a href="#performance-showcase" className="hover:text-blue-200 transition">Hiệu quả</a></li>
          ...
          <div id="mobile-menu" className="mobile-menu fixed top-0 right-0 w-64 h-screen bg-blue-900 text-white shadow-lg py-6 px-4 md:hidden">
            ...
            <nav>
              <ul className="flex flex-col space-y-4 text-lg font-medium">
                <li><a href="#" className="block hover:text-blue-200 transition">Trang chủ</a></li>
